...
class _DaycareHomeScreenState extends State<DaycareHomeScreen>
  ...
  Widget getListUI() {
    return Container(
      decoration: BoxDecoration(
        color: DaycareAppTheme.buildLightTheme().colorScheme.background,
        boxShadow: <BoxShadow>[
          BoxShadow(
  ...
  Widget getDaycareViewList() {
    final List<Widget> hotelListViews = <Widget>[];

    for (int i = 0; i < daycareList.length; i++) {
      final int count = daycareList.length;
      final Animation<double> animation =
          Tween<double>(begin: 0.0, end: 1.0).animate(
        CurvedAnimation(
          parent: animationController!,
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          Expanded(
            child: Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color:
                      DaycareAppTheme.buildLightTheme().colorScheme.background,
                ...
                child: Padding(
                  ...
                  child: TextField(
                    ...
                    cursorColor: DaycareAppTheme.buildLightTheme().primaryColor,
          ...
          Container(
            decoration: BoxDecoration(
              color: DaycareAppTheme.buildLightTheme().primaryColor,
              borderRadius: const BorderRadius.all(
                Radius.circular(38.0),
              ),
              boxShadow: <BoxShadow>[
